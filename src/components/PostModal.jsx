...
export default function PostModal({ open, onClose, onSave, onDelete, post, defaultDate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // El estatus de producción no se usa en este cliente: se guarda como
      // "publicado" por defecto para simplificar el modelo de datos.
      await onSave({ ...draft, platform, status: 'publicado' })
    } finally {
      setSaving(false)
    }
  }
